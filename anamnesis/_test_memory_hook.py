...
Run: python -u anamnesis/_test_memory_hook.py
...
os.environ["ANAMNESIS_PROJECT_ROOT"] = _ROOT

sys.path.insert(0, str(Path(__file__).resolve().parent))   # import THIS package
