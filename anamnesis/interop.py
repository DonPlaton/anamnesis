#!/usr/bin/env python3
"""Interop: make Anamnesis memory portable to other tools and standards.
...
AGENTS_START = "<!-- ANAMNESIS:START -->"
AGENTS_END = "<!-- ANAMNESIS:END -->"


def agents_md_block(project: str) -> str:
    """The Anamnesis project card rendered as an AGENTS.md managed block."""
    ...
    return f"{AGENTS_START}\n{body}\n\n_Maintained by Anamnesis — edits here are overwritten._\n{AGENTS_END}"
