...
*Companion to `research/consolidation_eval.py`. Reproduce: `ANAMNESIS_VAULT=/path python
...
the right design; the consolidation research stands as a **clean negative result** for the paper
