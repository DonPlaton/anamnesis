...
On the axis that matches a vendor headline, Anamnesis answers **78.8%** correct with a
...
ANAMNESIS_CLOUD=deepseek DEEPSEEK_API_KEY=… ANAMNESIS_DEEPSEEK_MODEL=deepseek-chat \
  python anamnesis/research/qa_eval.py --setting=oracle --reasoner --concurrency=14 \
...
ANAMNESIS_CLOUD=deepseek DEEPSEEK_API_KEY=… ANAMNESIS_DEEPSEEK_MODEL=deepseek-chat \
  python anamnesis/research/qa_eval.py --setting=both --cot --concurrency=16 \
...
python anamnesis/research/qa_eval.py --setting=both --budget=24000 --save
```
