...
(a note that could spark a novel connection). A knob `ANAMNESIS_DIVERGENCE ∈ [0,1]` should
...
`ANAMNESIS_DIVERGENCE` (default 0 = convergent, no change) re-ranks the top candidates by **MMR**
