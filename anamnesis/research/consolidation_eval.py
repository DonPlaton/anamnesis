...
LOCAL model; never prints, saves, or commits any note or principle text.
    ...
    ANAMNESIS_VAULT=/path python research/consolidation_eval.py --save
    ANAMNESIS_VAULT=/path ANAMNESIS_CONSOLIDATE_MODEL=qwen2.5:7b python research/consolidation_eval.py
...
MODEL = os.environ.get("ANAMNESIS_CONSOLIDATE_MODEL", m.OLLAMA_MODEL)
