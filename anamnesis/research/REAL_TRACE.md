...
`ANAMNESIS_VAULT=/path/to/vault python research/real_trace_bench.py --save` (CPU, no Ollama —
...
the same lesson genuinely recur. This is the load-bearing honesty caveat for the paper's headline.
