#!/usr/bin/env python3
"""RESEARCH — LongMemEval external retrieval benchmark for Anamnesis.
...
RERANK_N = int(os.environ.get("ANAMNESIS_RERANK_N", "10"))      # matches the R@10 pool ceiling
RERANK_SNIP = int(os.environ.get("ANAMNESIS_RERANK_SNIP", "700"))   # per-session passage budget
RERANK_MODEL = os.environ.get("ANAMNESIS_RERANK_MODEL", m.OLLAMA_MODEL)
XRERANK_SNIP = int(os.environ.get("ANAMNESIS_XRERANK_SNIP", "1200"))  # cross-encoder passage budget
