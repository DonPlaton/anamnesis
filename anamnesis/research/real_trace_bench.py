...
projects, or stems are printed or saved. Runs against ANAMNESIS_VAULT's cache.

    ANAMNESIS_VAULT=/path/to/vault python research/real_trace_bench.py
    ANAMNESIS_VAULT=/path/to/vault python research/real_trace_bench.py --save  # aggregate JSON
