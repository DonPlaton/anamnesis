...
def test_source_has_no_personal_data():
    ...
    persisted. Real project/name markers are supplied via ANAMNESIS_PRIVACY_MARKERS locally
    ...
    extra = [x.strip().lower() for x in os.environ.get("ANAMNESIS_PRIVACY_MARKERS", "").split(",")
             if x.strip()]
