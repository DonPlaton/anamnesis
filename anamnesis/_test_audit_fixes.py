...
try:
    check("ANAMNESIS_ADAPTIVE_RECUR=0 → always full weight (legacy)", m._ambiguity([0.7, 0.3]) == 1.0)
finally:
    m.ADAPTIVE_RECUR = _ar


# ── E3: posterior ranker mode (1A, ANAMNESIS_RANKER=posterior) ─────────
...
# ── E5: divergent recall MMR re-rank (2B, ANAMNESIS_DIVERGENCE) ────────
