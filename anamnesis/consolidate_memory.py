...
SIM_THRESHOLD = float(__import__("os").environ.get("ANAMNESIS_DEDUP_SIM", "0.92"))
...
MAX_LIVE_PER_PROJECT = int(__import__("os").environ.get("ANAMNESIS_MAX_LIVE_PER_PROJECT", "0"))
...
def cap_project_notes(cache: dict, apply: bool) -> int:
    ...
    silently shed memory. When ANAMNESIS_MAX_LIVE_PER_PROJECT>0, only the
