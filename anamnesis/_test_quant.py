...
ANAMNESIS_EMBED_QUANT=binary packs sign-bit codes in the SQLite scale-index: 16x
...
build+search end-to-end in binary mode.
    ...
    ANAMNESIS_EMBED_QUANT=binary python _test_quant.py    (env optional; set below)
"""
import math
import os
import sys
...
os.environ["ANAMNESIS_EMBED_QUANT"] = "binary"      # before importing the index module
